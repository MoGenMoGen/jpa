      ...
      <ul v-if="dataShow">
        ...
        <li>
          ...
          <div class="linkurl" :data-text="info.linkUrl">
            ...
            <!--(点击链接去完成任务）-->
            <div
              class="handlegofinish"
              @tap="
                toPage(
                  '/pages/wxDetail/main?url=' + encodeURIComponent(info.linkUrl)
                )
              "
            >
              点击去完成任务
        ...
        <li>
          ...
          <p class="ct" v-if="info.status == 20" style="color: #2983e7">
            {{ "发表完成" }}
          </p>
          <p class="ct" v-if="info.status == 30" style="color: #2983e7">
            {{ "审批未通" }}
          </p>
          <p class="ct" v-if="info.status == 40" style="color: #e33637">
            {{ "已撤销" }}
          </p>
        </li>
