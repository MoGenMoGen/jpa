    ...
    <div class="content" >
      ...
      <div class="index" v-if="type == 1">
        ...
        <div class="line">
          <div><p></p></div>
          <div>
            <p v-html="info.descr" style="height: 370rpx;"></p>
          </div>
        </div>
        <div class="bottom">
      ...
      <div class="answer" v-if="type == 2">
        <div class="head">
          ...
          <img src="http://jiapingan.oss-cn-hangzhou.aliyuncs.com/8033ac8e8eed4c04b17b0a878762ff3d.png" v-if="answerList[index]&&answerList[index].type == 3"/>
        ...
        <div class="cont">
          ...
          <!--填空题-->
          <div class="option" v-if="answerList[index]&&answerList[index].type == 3">
            <textarea placeholder="请输入答案" class="blank" v-model="answer"></textarea>
          </div>
          <div class="confirm"  >
            <p @click="toNext(answerList[index])">确定</p>
          </div>
        </div>
      </div>
    </div>
  ...
  export default {
    ...
    methods:{
      ...
      async getAnswer(){
        ...
        let data = await this.api.getQuestion(param)
      ...
      toNext(item){
        ...
        if(this.index+1 ==this.total){
          ...
          this.api.postQuestion(JSON.stringify(this.postAnswerList),duration + '&addrCd='+ this.cityCd + '&addrNm=' + this.city).then(res=>{
            if(res.code == 0){
              wx.showToast({
                title: "提交成功！", // 标题
              ...
              setTimeout(()=>{
                this.postIntegral();
                let url ='/pages/activity/index/main';
...
<style scoped lang="less">
  #home{
    ...
    background-image: url("http://jiapingan.oss-cn-hangzhou.aliyuncs.com/f14790b6f68a4c15b0dd2885b16e5ee4.png");
