...
<!--  <p class="title">平安鼎</p>-->
  <div class="form">
    <div class="input">
      <span>手机号码</span><span class="line">|</span><input type="number" v-model="info.username" maxlength="11" placeholder="请输入手机号码" />
    </div>
    <div class="input">
      <span>密码</span><span class="line">|</span><input  type="password" v-model="info.password" placeholder="请输入密码"/>
    </div>
    <button @click="login">登录</button>
  </div>
  <span class="toRegistered" @click="toRegister('/pages/login/register/main')">注册</span>
